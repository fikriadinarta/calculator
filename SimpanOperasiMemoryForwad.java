...
/**
 * Write a description of class SimpanOperasiMemoryForwad here.
 *
 * @author fikriadinarta
 * @version 0.1
 */
public class SimpanOperasiMemoryForwad implements SimpanOperasiCalculator
{
    private String[] dataMemori = new String[10];
    private int pointer = 0;
    private String tampilMemori;
    public SimpanOperasiMemoryForwad()
    {
